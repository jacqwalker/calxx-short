    	...
    	<section class="advert-main-container">
    		<section class="advert-container">
	    		...
	    		<form action="" method="post" enctype="multipart/form-data" class="advert-form">
	    			...
	    			<label class="advert-tickbox font-white">Standard - £349 ex VAT
	  				 <input type="radio" name="pricing" value="Standard - £349 ex VAT" tabindex="24" <?php if ($_POST['pricing'] == 'Standard - £349 ex VAT') echo 'checked="checked" ';?>" >
	  				 <span class="checkmark"></span>
					</label>

	    			<label class="advert-tickbox font-white">Popular - £499 ex VAT
	  				 <input type="radio" name="pricing" value="Popular - £499 ex VAT" tabindex="25" <?php if ($_POST['pricing'] == 'Popular - £499 ex VAT') echo 'checked="checked" ';?>" >
	  				 <span class="checkmark"></span>
					</label>

	    			<label class="advert-tickbox font-white">Premium - £649 ex VAT
	  				 <input type="radio" name="pricing" value="Premium - £649 ex VAT" tabindex="26" <?php if ($_POST['pricing'] == 'Premium - £649 ex VAT') echo 'checked="checked" ';?>">
	  				 <span class="checkmark"></span>
					</label>
